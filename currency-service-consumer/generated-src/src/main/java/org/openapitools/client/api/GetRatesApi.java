...
public class GetRatesApi {
     ...
     */
    public List<CurrencyRateDto> getRates() throws RestClientException {
     ...
     * 
     * <p><b>200</b> - Get rates successful
     * @return ResponseEntity&lt;List&lt;CurrencyRateDto&gt;&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<CurrencyRateDto>> getRatesWithHttpInfo() throws RestClientException {
        ...
        ParameterizedTypeReference<List<CurrencyRateDto>> localReturnType = new ParameterizedTypeReference<List<CurrencyRateDto>>() {};
